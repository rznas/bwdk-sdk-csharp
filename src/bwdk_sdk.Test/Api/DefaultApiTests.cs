...
namespace bwdk_sdk.Test.Api
{
    ...
    public sealed class DefaultApiTests : ApiTestsBase
    {
        ...
        /// <summary>
        /// Test WalletsApiV1WalletBalanceRetrieve
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task WalletsApiV1WalletBalanceRetrieveAsyncTest()
        {
            var response = await _instance.WalletsApiV1WalletBalanceRetrieveAsync();
            var model = response.Ok();
            Assert.IsType<WalletBalance>(model);
        }
    }
}
