...
{
    /// <summary>
    ///  Class for testing MerchantWalletApi
    /// </summary>
    public sealed class MerchantWalletApiTests : ApiTestsBase
    {
        private readonly IMerchantWalletApi _instance;

        public MerchantWalletApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IMerchantWalletApi>();
        }
