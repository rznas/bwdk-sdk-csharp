...
namespace bwdk_sdk.Model
{
    ...
    /// OrderError
    /// </summary>
    public partial class OrderError : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public OrderError(ErrorEnum error)
        {
            Error = error;
            OnCreated();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="OrderError" />
    /// </summary>
    public class OrderErrorJsonConverter : JsonConverter<OrderError>
    {
        /// <summary>
        /// Deserializes json to <see cref="OrderError" />
        /// </summary>
        ...
        public override OrderError Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ErrorEnum?> error = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "error":
                            ...
                            if (errorRawValue != null)
                                error = new Option<ErrorEnum?>(ErrorEnumValueConverter.FromStringOrDefault(errorRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (!error.IsSet)
                throw new ArgumentException("Property is required for class OrderError.", nameof(error));

            if (error.IsSet && error.Value == null)
                throw new ArgumentNullException(nameof(error), "Property is not nullable for class OrderError.");

            return new OrderError(error.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="OrderError" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="orderError"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, OrderError orderError, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, orderError, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="OrderError" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="orderError"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, OrderError orderError, JsonSerializerOptions jsonSerializerOptions)
        {
            var errorRawValue = ErrorEnumValueConverter.ToJsonValue(orderError.Error);
