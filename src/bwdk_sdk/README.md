...
additionalProperties:
  packageGuid: '{4A9AE983-BB91-447C-9BB5-F3209174434E}'
...
- appName: BWDK API
- appVersion: 1.0.0
- appDescription: &lt;div dir&#x3D;\&quot;rtl\&quot; style&#x3D;\&quot;text-align: right;\&quot;&gt;  # مستندات فروشندگان در سرویس خرید با دیجی‌کالا  این پلتفرم برای فروشندگان (مرچنت‌ها) جهت یکپارچه‌سازی خدمات پرداخت و تجارت الکترونیکی با سیستم خرید با دیجی‌کالا. شامل مدیریت سفارشات، ارسال، و احراز هویت فروشندگان است.  &lt;/div&gt; 
